      ...
      <section className="relative min-h-screen w-full overflow-hidden">
        ...
        >
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            Tailored brownfield solutions—revamps, upgrades, and capacity
            expansions—executed with zero compromise on safety and uptime. Our
            experts work in live plant environments to deliver faster, smarter,
            and safer results.
          </motion.p>
          <motion.div
        ...
        >
          ...
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Engineered upgrades executed with precision and speed.
            </p>
          </motion.div>
