...
import { ArrowRight, Anchor, Building2, Waves, ChevronRight } from 'lucide-react';
    ...
    <main className="bg-white text-black overflow-hidden">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        >
          ...
          <motion.p 
            ...
            variants={fadeInUp}
          >
            Our procurement and supply chain management team ensures timely and cost-effective sourcing of materials, equipment, and services worldwide. We maintain strong vendor networks, 
            apply rigorous quality and compliance standards, and manage logistics efficiently to support project execution without delays.
          </motion.p>
          
          <motion.div className="flex flex-col sm:flex-row gap-4" variants={fadeInUp}>
            <Link href="/contact" className="group bg-yellow-400 text-black px-8 py-4 rounded-lg font-semibold hover:bg-yellow-500 transition">
              <span className="flex items-center gap-2">
                Talk to our Experts
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </span>
            </Link>
            <Link href="#capabilities" className="group border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-black transition">
              <span className="flex items-center gap-2">
                Explore Solutions
      ...
      <motion.section className="bg-black text-white py-12 px-6" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { icon: Anchor, number: "30+", label: "Offshore Projects Completed" },
            { icon: Building2, number: "100K MT", label: "Heavy Lift Capacity" },
            { icon: Waves, number: "24/7", label: "Global Operations Support" }
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Icon className="w-12 h-12 mx-auto mb-4 text-white group-hover:text-yellow-400 transition" />
      ...
      <section id="capabilities" className="py-20 px-6 md:px-20 bg-white">
        <motion.div className="max-w-7xl mx-auto" initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerChildren}>
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            <h2 className="text-4xl md:text-5xl font-bold text-black mb-6">Offshore Capabilities</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We deliver end-to-end offshore solutions for the world’s toughest environments.
            </p>
          </motion.div>
          ...
          <div className="space-y-32">
            {[
              ...
              },
              {
                ...
                body: "We provide precision-engineered lift solutions for complex topside and subsea modules.",
                image: "/images/heavy_lift.jpg",
                icon: Building2,
              },
              {
                title: "Marine Support & Logistics",
                body: "Integrated marine services that ensure smooth offshore operations — from tug to tow.",
                image: "/images/marine_logistics.jpg",
                icon: Waves,
              }
            ].map(({ title, body, image, icon: Icon }, index) => (
              <motion.div
                key={index}
                className={`flex flex-col lg:flex-row ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''} items-center gap-16`}
                variants={fadeInUp}
              >
                ...
                <div className="lg:w-1/2 space-y-6">
                  ...
                  <Link href="/contact" className="group inline-flex items-center gap-2 bg-black text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-all">
                    Learn More
