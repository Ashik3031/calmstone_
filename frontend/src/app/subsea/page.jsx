    ...
    <main className="bg-white text-black overflow-hidden">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        >
          ...
          >
           & Execution<br />
            {/* <span className="text-yellow-400">Floating Facilities</span> */}
          </motion.h1>
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
           Our project management services are built on international best practices, ensuring 
           projects are delivered on time, within budget, and to the highest standards. We provide full project lifecycle management, including planning, risk mitigation, 
           cost control, and stakeholder coordination, ensuring transparency and accountability at every phase.
          </motion.p>
        ...
        >
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive deep-sea solutions for floating infrastructure and lifecycle operations.
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="lg:w-1/2 space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Link
                      href="/contact"
                      className="group inline-flex items-center gap-2 bg-black text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-all duration-300"
                    >
                      Learn More
                    ...
                    <Link
                      href="#"
                      className="group inline-flex items-center gap-2 border-2 border-black text-black px-6 py-3 rounded-lg font-semibold hover:bg-black hover:text-white transition-all duration-300"
                    >
                      View Case Studies
